...
- [SF Symbols](https://developer.apple.com/sf-symbols/) — Apple system icons used throughout the UI

## Tools

- [XcodeGen](https://github.com/yonaskolb/XcodeGen) — Xcode project generation from YAML spec
